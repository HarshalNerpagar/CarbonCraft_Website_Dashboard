                                            ...
                                            <div class="tw-mt-3">
                                                @php
                                                    ...
                                                    $badgeColor = match($createdByName) {
                                                        ...
                                                        'Sayali' => 'bg-warning-600 text-white',
                                                        'Hitesh' => 'bg-warning-600 text-white',
                                                        'Website' => 'bg-info-600 text-white',
                                                        default => 'bg-secondary-600 text-white'
                                                    };
                                                @endphp
                                                <span class="badge {{ $badgeColor }} px-3 py-2 rounded fw-semibold" style="font-size: 0.875rem;">
                                                    {{ $createdByName }}
                                                </span>
                                            </div>
                                        </div>
