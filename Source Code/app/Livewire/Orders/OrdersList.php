...
class OrdersList extends Component
{
    ...
    public function payment($id)
    {
        ...
        $this->payment_type = '2'; // Default to Online payment
    }
    /* reset input fields */
    private function resetInputFields()
    {
        ...
        $this->note = '';
        $this->payment_mode = "";
        $this->payment_type = '2'; // Reset to Online payment
    }
    ...
    public function addPayment()
    {
        ...
        if ($this->balance) {
            ...
            $this->reloadOrders(); // Refresh the orders list
            $this->dispatch('closemodal');
            $this->dispatch(
                'alert',
                ['type' => 'success',  'message' => 'Payment Successfully Added!']
            );
        }
    }
    /* refresh the page */
    ...
    public function filterdata()
    {
        ...
        $baseQuery = \App\Models\Order::with(['user', 'customer'])
        ...
        if ($this->order_filter && $this->order_filter != '') {
            $baseQuery->where('status', $this->order_filter);
        }

        // Execute query with cursor pagination
        return $baseQuery->cursorPaginate(20, ['*'], 'cursor', Cursor::fromEncoded($this->nextCursor));
    }
